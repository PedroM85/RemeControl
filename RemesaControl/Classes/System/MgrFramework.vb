Public Class MgrFramework
    Inherits Unelsoft.Common.EWFramework
    ...
    Public Function GetSalesDateInfo() As SalesDateInfo()
        Dim oDataLayer As New Unelsoft.DataLayer.SalesDateDataLayer
        Dim _SalesDateInfo As New SalesDateInfo
        With _SalesDateInfo
            oDataLayer.GetGeneralInfo(.SalesDateId, .OpeningDate, .PosSessionsOpened, .UserLoggedOn)
